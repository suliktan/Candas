...
DEBUG = False
ALLOWED_HOSTS = [
    'www.medisinskayaodezhda.ru',
    'medisinskayaodezhda.ru',
    'webapp-2932975.pythonanywhere.com',
    'localhost',
    '127.0.0.1',
]

# Настройки для работы через Cloudflare
SECURE_PROXY_SSL_HEADER = ('HTTP_X_FORWARDED_PROTO', 'https')

# Доверяем домену для защиты от CSRF-атак (особенно важно для админки)
CSRF_TRUSTED_ORIGINS = [
    'https://www.medisinskayaodezhda.ru',
    'https://medisinskayaodezhda.ru'
]

# Рекомендуется также включить автоматический редирект на HTTPS
