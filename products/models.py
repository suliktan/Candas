...
class Category(models.Model):
    ...
    type = models.CharField(max_length=10, choices=TYPE_CHOICES, verbose_name="Тип категории", blank=True)
    banner_image = models.ImageField(upload_to='banners/', verbose_name="Баннер категории", blank=True, null=True)
